...
SECRET_KEY = 'django-insecure-o84cda0)^!n^z36@x9$3mk70=(5m8ya6)szav(8@%2$3566gjq'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'django_rest_auth.jwt_auth.JWTCookieAuthentication',
    )
